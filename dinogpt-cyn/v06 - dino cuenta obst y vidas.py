...
el codigo que no funcionaba lo converti en un contador de colisiones
y le agregue un contador de colisiones

si choca, guarda "choco"
si no choca, guarda "no choco"
